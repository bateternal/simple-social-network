...
urlpatterns = [
	...
	url(r'^addmessage$',views.add_message,name="add message"),
	url(r'^sync$',views.sync_messages,name='sync'),
...
] + static(settings.MEDIA_URL, document_root=settings.MEDIA_ROOT) + [url(r'',views.other,name='other')] + static(settings.STATIC_URL, document_root=settings.STATIC_ROOT)